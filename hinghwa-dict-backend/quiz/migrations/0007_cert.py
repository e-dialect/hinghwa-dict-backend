...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='paper',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='quiz_paper', to='quiz.paperrecord', verbose_name='所在答卷记录'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cert_user', to=settings.AUTH_USER_MODEL, verbose_name='证书用户')),
            ],
        ),
    ]
