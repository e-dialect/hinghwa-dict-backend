    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('views', models.IntegerField(default=0, editable=False, verbose_name='阅读量')),
                ('publish_time', models.DateTimeField(auto_now_add=True, verbose_name='发布时间')),
                ('update_time', models.DateTimeField(verbose_name='最近更新时间')),
                ('title', models.CharField(max_length=100, verbose_name='标题')),
                ('description', models.TextField(blank=True, max_length=300, verbose_name='简介')),
                ...
                ('like_users', models.ManyToManyField(blank=True, editable=False, related_name='like_articles', to=settings.AUTH_USER_MODEL, verbose_name='点赞用户')),
            ],
            options={
                'verbose_name': '文章',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sons', to='article.comment', verbose_name='父评论')),
