    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='list_words', to=settings.AUTH_USER_MODEL, verbose_name='词单作者')),
                ('words', models.ManyToManyField(blank=True, related_name='included_word', to='word.Word', verbose_name='词语')),
            ],
        ),
    ]
