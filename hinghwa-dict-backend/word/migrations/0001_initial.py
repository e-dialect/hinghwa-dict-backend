    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('traditional', models.CharField(default='', max_length=30, verbose_name='繁体字')),
            ],
            options={
                'verbose_name': '单字',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verifier',models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='verified_pronunciations', to=settings.AUTH_USER_MODEL, verbose_name='审核人')),
            ],
            options={
                'verbose_name': '语音',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_word', models.CharField(blank=True, max_length=60, verbose_name='词')),
                ('definition', models.TextField(blank=True, verbose_name='注释')),
                ('annotation', models.TextField(blank=True, verbose_name='附注')),
                ('mandarin', models.TextField(blank=True, default='[]', verbose_name='对应普通话词语')),
                ('standard_ipa', models.CharField(blank=True, max_length=30, verbose_name='标准IPA')),
                ('standard_pinyin', models.CharField(blank=True, max_length=30, verbose_name='标准拼音')),
                ('contributor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to=settings.AUTH_USER_MODEL, verbose_name='贡献者')),
                ('related_articles', models.ManyToManyField(blank=True, related_name='related_applications', to='article.Article', verbose_name='相关帖子')),
                ('related_words', models.ManyToManyField(blank=True, related_name='related_applications', to='word.Word', verbose_name='相关词汇')),
                ('verifier', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='verified_applications', to=settings.AUTH_USER_MODEL, verbose_name='审核人')),
                ('word', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='word.word', verbose_name='关联词条')),
            ],
            options={
                'verbose_name': '词语修改申请',
