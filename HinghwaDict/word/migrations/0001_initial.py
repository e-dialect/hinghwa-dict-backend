    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contributor', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='contribute_words', to=settings.AUTH_USER_MODEL, verbose_name='贡献者')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visibility', models.BooleanField(default=False, verbose_name='是否审核')),
                ('views', models.IntegerField(default=0, editable=False, verbose_name='访问量')),
                ('contributor', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='contribute_pronunciation', to=settings.AUTH_USER_MODEL, verbose_name='贡献者')),
