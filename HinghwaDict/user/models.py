...
class UserInfo(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, related_name='user_info', verbose_name='用户',
                                primary_key=True)
    wechat = models.CharField(max_length=128, blank=True, verbose_name="微信标识码", editable=False)  # openid
    qq = models.CharField(max_length=128, blank=True, verbose_name="qq标识码", editable=False)  # openid
    ...
    avatar = models.URLField(default='https://hinghwadict-1259415432.cos.ap-shanghai.myqcloud.com/'
